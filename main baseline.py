...
async def setup_driver(notebook_id: str):
    ...
    print("Setting up new driver instance (headless mode)...")

    # Create a temporary directory for the user data profile
    # Ensure this is created fresh for each session
    new_user_data_dir = tempfile.mkdtemp(prefix="selenium_profile_")
    print(f"Created temporary user data directory: {new_user_data_dir}")
